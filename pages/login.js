        ...
        <>
            <div className="w-full min-h-screen flex justify-center items-center bg-[url('/assets/08.webp')] bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/50 px-4 md:px-8 xxl:px-0">
                <div className="h-fit max-w-xl w-full bg-white   rounded-2xl shadow-md flex flex-col items-center py-10 px-5 ">
                    ...
                    <form onSubmit={handleSubmit} className="max-w-sm w-full p-5 gap-4 flex-col flex ">
                        ...
                        <div className=" flex items-center py-2 px-3 border border-gray-300 rounded-3xl">
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} type="text" name="username" id="username" placeholder="Username" className="w-full outline-none border-none  placeholder:text-sm pl-2 " required />
                        </div>
                        ...
                        <div className=" flex items-center py-2 px-3 border border-gray-300 rounded-3xl">
                            ...
                            <input onChange={(e) => setPassword(e.target.value)} type={show ? "text" : "password"} name="password" id="password" placeholder="Password" autoComplete="on" className="w-full outline-none border-none  placeholder:text-sm pl-2" required />
