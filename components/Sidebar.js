                    ...
                    <div className="divide-y divide-[#818384] divide-opacity-25 flex flex-col  ">
                        ...
                        {menu.map((item, index) => (
                            <Link key={index} href={item.href}>
                                ...
                                <p className={classNames(router.pathname === item.href ? "text-white bg-[#323435]" : "text-[#818384]", "hover:text-white hover:bg-[#323435] p-3 shadow-md rounded-lg cursor-pointer inline-flex gap-4 font-light")}>
