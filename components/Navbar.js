    ...
    return (
        <>
            <div className="w-full h-20 bg-white rounded shadow-sm px-4 md:px-10 flex justify-between items-center">
                ...
                <button id="menuBtn" type="button" onClick={ToggleSidebar} className="absolute md:hidden -translate-y-12 -translate-x-2">

                    <span
                        id="menu"
                        className={menuBar ? "menu open" : "menu"}
                    >
                        <span className=""></span>
                ...
                <div className="ml-10 md:ml-0 flex-shrink-0">
            ...
            <div className={classNames(menuBar ? "opacity-100 z-50 " : "opacity-0 z-[-99]", "bg-black/50 fixed w-full h-screen  top-0 left-0 duration-300")}
            >
                <div className={classNames(menuBar ? "translate-x-0" : "-translate-x-full", "w-72 h-full bg-black top-0 left-0 p-8 flex flex-col justify-between relativ duration-500 ")}
                >
                    <div >

                        <button onClick={ToggleSidebar} className="w-10 h-10 absolute bg-white rounded-full right-5 top-5 flex justify-center items-center">
                        ...
                        <p className="mb-2 uppercase text-[#4B4D4F] text-xs">menu</p>
